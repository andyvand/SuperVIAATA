...
#ifndef _SuperVIAATADRIVER_H
#define _SuperVIAATADRIVER_H
...
class SuperVIAATADriver : public IOPCIATA
{
    OSDeclareDefaultStructors( SuperVIAATADriver )

protected:
    SuperVIAATAChannel *       fProvider;
