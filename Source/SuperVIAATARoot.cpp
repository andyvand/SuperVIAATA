...
#include "SuperVIAATARoot.h"
#include "SuperVIAATAChannel.h"
#include "SuperVIAATAHardware.h"

#define super IOService
OSDefineMetaClassAndStructors( SuperVIAATARoot, IOService )
...
IOService * SuperVIAATARoot::probe( IOService * provider, SInt32 * score )
{
...
bool SuperVIAATARoot::start( IOService * provider )
{
    OSDictionary * match;
    ...
    {        
        ...
        /*static IONotifier * addNotification(
         ...
         SInt32 priority = 0 );
        */
        fISABridgeNotifier = addMatchingNotification(gIOFirstPublishNotification, match, isaBridgePublished, this);
...
void SuperVIAATARoot::free( void )
{
...
/*bool SuperVIAATARoot::isaBridgePublished( void *      target,
                                          void *      param,
                                          IOService * service )*/
bool SuperVIAATARoot::isaBridgePublished( void *      target,
                                          void *      param,
                                          IOService * service,
                                          IONotifier * notification)
{
    IOPCIDevice *         bridge;
    SuperVIAATARoot *     root = (SuperVIAATARoot *) target;
...
IORegistryEntry * SuperVIAATARoot::getDTChannelEntry( int channelID )
{
...
OSSet * SuperVIAATARoot::createATAChannels( void )
{
    OSSet *           nubSet;
    ...
    do {
        ...
        {        
            ...
            SuperVIAATAChannel * nub = new SuperVIAATAChannel;
            if ( nub )
            {
...
OSDictionary *
SuperVIAATARoot::createNativeModeChannelInfo( UInt32 ataChannel )
{
...
OSDictionary *
SuperVIAATARoot::createLegacyModeChannelInfo( UInt32 ataChannel )
{
    UInt16  cmdPort = 0;
    UInt16  ctrPort = 0;
    UInt8   isaIrq  = 0;
...
OSDictionary *
SuperVIAATARoot::createChannelInfo( UInt32 ataChannel,
                                    UInt16 commandPort,
                                    UInt16 controlPort,
...
bool SuperVIAATARoot::handleOpen( IOService *  client,
...
void SuperVIAATARoot::handleClose( IOService *  client,
                                   IOOptionBits options )
{
...
bool SuperVIAATARoot::handleIsOpen( const IOService * client ) const
{
    if (client)
...
UInt32 SuperVIAATARoot::getHardwareType( void ) const
{
    return fHardwareType;
}

UInt32 SuperVIAATARoot::getHardwareFlags( void ) const
{
    return fHardwareFlags;
}

UInt32 SuperVIAATARoot::getUltraDMAModeMask( void ) const
{
...
void SuperVIAATARoot::pciConfigWrite8( UInt8 offset, UInt8 data, UInt8 mask )
{
    UInt8 u8;
...
void SuperVIAATARoot::pciConfigWrite16( UInt8 offset, UInt16 data, UInt16 mask )
{
    UInt16 u16;
...
void SuperVIAATARoot::pciConfigWrite32( UInt8 offset, UInt32 data, UInt32 mask )
{
    UInt8 u32;
...
UInt8 SuperVIAATARoot::pciConfigRead8( UInt8 offset )
{
    return fProvider->configRead8( offset );
}

UInt16 SuperVIAATARoot::pciConfigRead16( UInt8 offset )
{
    return fProvider->configRead16( offset );
}

UInt32 SuperVIAATARoot::pciConfigRead32( UInt8 offset )
{
