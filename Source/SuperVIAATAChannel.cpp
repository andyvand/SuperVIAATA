...
OSDefineMetaClassAndStructors( SuperVIAATAChannel, IOService )

//---------------------------------------------------------------------------

bool SuperVIAATAChannel::mergeProperties( OSDictionary * properties )
{
    bool success = true;
...
const char * SuperVIAATAChannel::getControllerName( void ) const
{
        return "UNKNOWN";
}


bool SuperVIAATAChannel::init( IOService *       provider,
                               ...
                               IORegistryEntry * dtEntry )
{
    ...
    fProvider = OSDynamicCast(SuperVIAATARoot, provider);
    if (fProvider == 0)
        return false;
...
bool SuperVIAATAChannel::handleOpen( IOService *  client,
...
void SuperVIAATAChannel::handleClose( IOService *  client,
                                      IOOptionBits options )
{
...
UInt16 SuperVIAATAChannel::getCommandBlockAddress( void ) const
{
    UInt16 value = 0xFFF0;
...
UInt16 SuperVIAATAChannel::getControlBlockAddress( void ) const
{
    UInt16 value = 0xFFF0;
...
UInt32 SuperVIAATAChannel::getInterruptVector( void ) const
{
    UInt32 value = 0xFF;
...
UInt32 SuperVIAATAChannel::getChannelNumber( void ) const
{
    UInt32 value = 0xFF;
...
UInt32 SuperVIAATAChannel::getUltraDMAModeMask( void ) const
{
    return fProvider->getUltraDMAModeMask();
}

UInt32 SuperVIAATAChannel::getHardwareType( void ) const
{
    return fProvider->getHardwareType();
}

UInt32 SuperVIAATAChannel::getHardwareFlags( void ) const
{
    return fProvider->getHardwareFlags();
}

const char * SuperVIAATAChannel::getHardwareName( void ) const
{
    OSString * name;
...
void SuperVIAATAChannel::pciConfigWrite8( UInt8 offset,
                                          UInt8 data,
                                          UInt8 mask )
{
...
void SuperVIAATAChannel::pciConfigWrite16( UInt8 offset,
										 UInt16 data,
										 UInt16 mask )
{
...
void SuperVIAATAChannel::pciConfigWrite32( UInt8  offset,
                                           UInt32 data,
                                           UInt32 mask )
{
...
UInt8 SuperVIAATAChannel::pciConfigRead8( UInt8 offset )
{
    return fProvider->pciConfigRead8( offset );
}

UInt16 SuperVIAATAChannel::pciConfigRead16( UInt8 offset )
{
    return fProvider->pciConfigRead16( offset );
}

UInt32 SuperVIAATAChannel::pciConfigRead32( UInt8 offset )
{
...
bool SuperVIAATAChannel::getNumberValue( const char * propKey,
                                         void       * outValue,
