...
#ifndef _SuperVIAATACHANNEL_H
#define _SuperVIAATACHANNEL_H

#include <IOKit/IOService.h>
class SuperVIAATARoot;

class SuperVIAATAChannel : public IOService
{
    OSDeclareDefaultStructors( SuperVIAATAChannel )

protected:
    SuperVIAATARoot * fProvider;
