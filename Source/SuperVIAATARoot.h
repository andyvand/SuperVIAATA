...
#ifndef _SuperVIAATAROOT_H
#define _SuperVIAATAROOT_H

#include <IOKit/IOLocks.h>
#include <IOKit/pci/IOPCIDevice.h>

class SuperVIAATARoot : public IOService
{
    OSDeclareDefaultStructors( SuperVIAATARoot )
